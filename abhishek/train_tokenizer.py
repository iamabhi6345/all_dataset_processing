...
from abhishek.config_schemas.tokenizer_training_config_schema import TokenizerTrainingConfig
from abhishek.utils.config_utils import get_pickle_config
from abhishek.utils.io_utils import write_yaml_file
from abhishek.utils.utils import get_logger


@get_pickle_config(config_path="abhishek/configs/automatically_generated", config_name="tokenizer_training_config")
